...
export const GenerateCodeModal = forwardRef<GenerateCodeModalHandle, Props>((props, ref) => {
  ...
  return (
    <Modal ref={modalRef} tall {...props}>
      <ModalHeader>{t('generateCode.title')}</ModalHeader>
      <ModalBody
        noScroll
        style={{
          display: 'grid',
      ...
      >
        <div className="pad">
          <Dropdown
            aria-label={t('generateCode.selectTarget')}
            triggerButton={
              <DropdownButton className="btn btn--clicky">
                {target ? target.title : t('generateCode.notAvailable')}
          ...
          &nbsp;&nbsp;
          <Dropdown
            aria-label={t('generateCode.selectClient')}
            triggerButton={
              <DropdownButton className="btn btn--clicky">
                {client ? client.title : t('generateCode.notAvailable')}
                <i className="fa fa-caret-down" />
              </DropdownButton>
            }
          >
        ...
        {target && <CodeEditor
          ...
          placeholder={t('generateCode.generatingCodeSnippet')}
      ...
      <ModalFooter>
        <div className="margin-left italic txt-sm">
          {t('generateCode.codeSnippetsGeneratedBy')}&nbsp;
