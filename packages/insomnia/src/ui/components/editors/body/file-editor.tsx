  ...
  return (
    <div className="text-center">
      <div className="pad text-left">
        <label className="label--small">{t('fileEditor.selectedFile')}</label>
        ...
        </code> : <code className="super-faint block txt-sm">{t('fileEditor.noFileSelected')}</code>}
      </div>
      <div>
        <PromptButton className="btn btn--super-compact" disabled={!path} onClick={_handleResetFile}>
          {t('fileEditor.resetFile')}
        </PromptButton>
          &nbsp;&nbsp;
